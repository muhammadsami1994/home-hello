(function(){
    ...
    function flexCalendar() {
        ...
        var template =
            ...
            '<div class="month" style="background-color: white !important;">'+
            '<div style="margin-left: 8px;margin-top: 13px;">'+
            '<img src="img/calendarBackArrow.png" style="width: 2.5em;" ng-click="prevMonth()">'+
            '</div>'+
            '<div class="label">{{ selectedMonth | translate }}</div>'+
            '<div style="margin-right: 8px;margin-top: 13px;">'+
            '<img src="img/calendarFrontArrow.png" style="width: 2.5em;" ng-click="nextMonth()">'+
            '</div>' +
            '</div>'+
            '<div class="week" style="color : rgba(58, 61, 64, 0.84) !important">'+
    ...
    function Controller($scope , $filter) {
        ...
        function disabledDate(date) {
            ...
            for(var i = 0; i < $scope.mappedDisabledDates.length; i++){
                if(date.year === $scope.mappedDisabledDates[i].getFullYear() && date.month === $scope.mappedDisabledDates[i].getMonth() && date.day === $scope.mappedDisabledDates[i].getDate()+1){
                    return true;
                    break;
                }
            }
